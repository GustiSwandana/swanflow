...
@section('custom_header')
    ...
    <div class="bg-gradient-to-b from-emerald-600 to-emerald-700 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 border-b border-emerald-700 dark:border-slate-800/80 text-white px-5 pb-6 relative transition-colors" style="padding-top: max(3.5rem, calc(var(--sat, 0px) + 0.75rem));">
        <!-- Top Navigation Bar -->
