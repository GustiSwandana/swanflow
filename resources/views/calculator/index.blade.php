...
<div class="bg-slate-50 dark:bg-slate-900 rounded-t-[32px] pt-5 px-4 pb-24 shadow-2xl -mt-4 relative z-10 border-t border-slate-200 dark:border-slate-800/80 min-h-[550px] space-y-5 text-slate-800 dark:text-white transition-colors">
    <!-- Drag Pill Indicator -->
