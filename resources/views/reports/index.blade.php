...
@section('custom_header')
    ...
    <div class="bg-gradient-to-b from-emerald-600 to-emerald-700 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 border-b border-emerald-700 dark:border-slate-800/80 text-white pt-[max(1rem,calc(var(--sat)+0.75rem))] px-5 pb-8 relative transition-colors">
        <!-- Top Navigation Bar -->
...
<div class="bg-slate-50 dark:bg-slate-900 rounded-t-[32px] pt-5 px-4 pb-8 shadow-2xl -mt-4 relative z-10 border-t border-slate-200 dark:border-slate-800/80 min-h-[550px] space-y-5 text-slate-800 dark:text-white transition-colors">
    <!-- Drag Pill Indicator -->
