        ...
        <div class="space-y-2.5">
            @forelse($recentTransactions ?? [] as $tx)
                ...
                <div data-transaction-row="{{ $tx->id }}"
                     ...
                     class="p-3 flex items-center justify-between rounded-2xl bg-white dark:bg-slate-800/60 hover:bg-slate-100/80 dark:hover:bg-slate-800 transition-colors border border-slate-200/80 dark:border-slate-800 shadow-2xs">
                    ...
                    <div class="flex items-center gap-1.5 shrink-0 pl-2">
                        ...
                        <button type="button" 
                                ...
                                class="min-w-[36px] min-h-[36px] w-9 h-9 flex items-center justify-center text-slate-300 dark:text-slate-600 hover:text-rose-500 dark:hover:text-rose-400 rounded-xl hover:bg-rose-50 dark:hover:bg-rose-950/40 active:scale-95 transition-all cursor-pointer">
